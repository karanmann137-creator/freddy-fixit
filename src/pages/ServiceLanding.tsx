...
export const SERVICES: Record<string, Svc> = {
  "handyman": {
    ...
    metaDesc: "Need a handyman in Calgary? Post your job free and get up to 3 fixed-price quotes from vetted, insured local pros. Payment held safe until the work is done right.",
    ...
    intro: [
      ...
      "Post your job in a couple of minutes, get up to three fixed-price quotes, and book the pro you like best. Your payment is held securely and only released once you confirm the work is done right.",
    ],
    cover: [
    ...
    faqs: [
      { q: "How much does a handyman cost in Calgary?", a: "Most Calgary handyman work is quoted by the job rather than the hour, so you see one fixed price before you book. Small jobs typically start in the low hundreds. You get up to three quotes to compare, with no obligation." },
  ...
  "plumbing": {
    name: "Plumbing",
    icon: "pipe",
    metaTitle: "Plumber in Calgary | Licensed & Insured | Up to 3 Quotes — Freddy Fix It",
    metaDesc: "Find a licensed plumber in Calgary fast. Post your leak, install or repair and get up to 3 fixed-price quotes from vetted local plumbers. Payment protected until you're satisfied.",
    ...
    intro: [
      ...
      "Describe the problem, get up to three fixed-price quotes, and choose your plumber. Funds are held safely and released only when you confirm the job's done.",
    ],
    cover: [
    ...
    faqs: [
      { q: "How fast can I get a plumber in Calgary?", a: "Once you post a job, vetted plumbers can quote quickly. For urgent leaks, flag the job as urgent so nearby pros are notified right away." },
  ...
  "electrical": {
    ...
    metaDesc: "Hire a certified electrician in Calgary. Post your job and get up to 3 fixed-price quotes from vetted, insured local electricians. Safe, code-compliant work, payment protected.",
    ...
    intro: [
      ...
      "Post the job, compare up to three fixed-price quotes, and book with confidence. Your money is held until you confirm the work is finished properly.",
    ],
    cover: [
    ...
    faqs: [
      ...
      { q: "Can I get a quote for a panel upgrade?", a: "Absolutely. Describe the job (and add photos of your panel if you can) and you'll get up to three fixed-price quotes to compare." },
  ...
  "hvac": {
    ...
    metaDesc: "Furnace acting up? Get vetted Calgary HVAC pros for heating, cooling and ventilation. Post your job, get up to 3 fixed-price quotes. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your job, get up to three fixed-price quotes, and book a pro. Payment is protected and only released when the work is confirmed done.",
    ],
    cover: [
    ...
    faqs: [
      { q: "My furnace stopped working — how fast can someone come?", a: "Mark the job urgent and nearby HVAC pros are notified right away so you can get quotes and book quickly." },
      { q: "How much is a furnace tune-up in Calgary?", a: "Tune-ups are usually quoted as a flat job price. You'll see up to three quotes to compare before you commit — no surprise charges." },
  ...
  "carpentry": {
    ...
    metaDesc: "Find a skilled carpenter in Calgary for custom builds, repairs and finishing. Post your job, get up to 3 fixed-price quotes from vetted local pros. Payment protected.",
    ...
    intro: [
      ...
      "Post your project, compare up to three fixed-price quotes, and book the carpenter whose work you like best — with your payment held until you're happy.",
    ],
    cover: [
    ...
    faqs: [
      { q: "Can I get a quote for custom work?", a: "Yes. Describe what you want (photos and rough dimensions help) and you'll get up to three fixed-price quotes from local carpenters." },
  ...
  "painting": {
    ...
    metaDesc: "Hire vetted painters in Calgary for interior and exterior jobs. Post your project, get up to 3 fixed-price quotes from insured local pros. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your job, get up to three fixed-price quotes, and book your painter. Payment is held until the work is confirmed done right.",
    ],
    cover: [
    ...
    faqs: [
      { q: "How much does painting cost in Calgary?", a: "Painting is usually quoted per room or per job. You'll get up to three fixed-price quotes so you can compare before booking." },
      { q: "Do painters supply the paint?", a: "That's up to each quote — many include materials. Note your preference when you post and the pros will price accordingly." },
  ...
  "drywall-flooring": {
    ...
    metaDesc: "Calgary drywall and flooring pros for patches, repairs and full installs. Post your job, get up to 3 fixed-price quotes from vetted locals. Payment held until you're happy.",
    ...
    intro: [
      ...
      "Post the job, compare up to three fixed-price quotes, and book — with your payment protected until you confirm the work is done.",
    ],
    cover: [
    ...
    faqs: [
      { q: "Can you patch a small hole in drywall?", a: "Yes — small repairs are some of the most common jobs booked. Post it and you'll get fixed-price quotes fast." },
      { q: "Do you do full flooring installs?", a: "Absolutely. Describe the space and material and you'll get up to three quotes from flooring pros." },
  ...
  "landscaping": {
    ...
    metaDesc: "Calgary landscaping, lawn care and yard cleanup from vetted local pros. Post your job, get up to 3 fixed-price quotes. Payment held until the work is done right.",
    ...
    intro: [
      ...
      "Post your job, get up to three fixed-price quotes, and book the crew you like. Payment is held until you confirm the work is finished.",
    ],
    cover: [
    ...
    faqs: [
      { q: "Do you offer recurring lawn care?", a: "Many landscapers quote both one-time and recurring service. Note what you want when you post and pros will price accordingly." },
      { q: "How do quotes work?", a: "You get up to three fixed-price quotes to compare — no hourly surprises." },
  ...
  "snow-removal": {
    ...
    metaDesc: "Reliable Calgary snow removal for driveways, walks and lots. Post your job, get up to 3 fixed-price quotes from vetted local crews. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your job, compare up to three fixed-price quotes, and book. Payment is protected until the work is confirmed done.",
    ],
    cover: [
    ...
    faqs: [
      { q: "Can I book seasonal snow removal?", a: "Yes — note that you want a seasonal contract when you post and crews will quote accordingly." },
  ...
  "gutters": {
    ...
    metaDesc: "Calgary gutter cleaning, repair and installs from vetted local pros. Post your job, get up to 3 fixed-price quotes. Payment held until the work is done right.",
    ...
    intro: [
      ...
      "Post the job, compare up to three fixed-price quotes, and book — with payment held until you confirm it's done.",
    ],
    cover: [
    ...
    faqs: [
      { q: "How often should Calgary gutters be cleaned?", a: "Twice a year is typical — spring and fall. Post the job and you'll get fixed-price quotes from local pros." },
      { q: "Can you fix a leaking gutter?", a: "Yes. Add a photo of the problem area when you post and you'll get accurate quotes." },
  ...
  "siding-roofing": {
    ...
    metaDesc: "Calgary roofing and siding repair, replacement and leak protection from vetted pros. Post your job, get up to 3 fixed-price quotes. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your job, get up to three fixed-price quotes, and book with confidence — payment held until the work is confirmed done.",
    ],
    cover: [
      "Roof leak repair",
      "Shingle replacement",
    ...
    faqs: [
      { q: "I had hail damage — can you help?", a: "Yes. Calgary sees serious hail, and storm-damage repair is one of the most common roofing jobs. Add photos when you post for accurate quotes." },
      { q: "Do you do full roof replacements?", a: "Absolutely — describe the roof and you'll get up to three fixed-price quotes from local roofers." },
  ...
  "concrete-masonry": {
    ...
    metaDesc: "Calgary concrete and masonry pros for driveways, patios, walks and repairs. Post your job, get up to 3 fixed-price quotes from vetted locals. Payment protected.",
    ...
    intro: [
      ...
      "Post your project, compare up to three fixed-price quotes, and book — with your payment held until you confirm the job's done.",
    ],
    cover: [
    ...
    faqs: [
      { q: "Can you repair cracked concrete?", a: "Yes — repairs are common. Add a photo when you post for accurate fixed-price quotes." },
      { q: "Do you pour new driveways?", a: "Absolutely. Describe the area and you'll get up to three quotes from local pros." },
  ...
  "appliance-repair": {
    ...
    metaDesc: "Calgary appliance repair and installation for all major brands. Post your job, get up to 3 fixed-price quotes from vetted local pros. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post the make, model and problem, get up to three fixed-price quotes, and book. Payment is held until you confirm the fix.",
    ],
    cover: [
    ...
    faqs: [
      { q: "Can you tell me if it's worth repairing?", a: "Pros will assess and quote — often the diagnosis tells you whether repair or replacement makes more sense. Add the make and model when you post." },
      { q: "Do you install new appliances?", a: "Yes — installs and hookups are common jobs. Note what you need and you'll get fixed-price quotes." },
  ...
  "vehicle-maintenance": {
    ...
    metaDesc: "Calgary vehicle maintenance — oil changes, tires, brakes and more from vetted local pros. Post your job, get up to 3 fixed-price quotes. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your vehicle and the service you need, get up to three fixed-price quotes, and book. Payment is held until the work is confirmed done.",
    ],
    cover: [
    ...
    faqs: [
      ...
      { q: "How do quotes work?", a: "You'll get up to three fixed-price quotes to compare before you book — no hourly surprises." },
      { q: "Is payment protected?", a: "Yes — funds are held securely until you confirm the work is complete." },
    ],
  ...
  "air-conditioning": {
    ...
    metaDesc: "Calgary AC installs, tune-ups and repairs from vetted local pros. Post your job, get up to 3 fixed-price quotes. Payment held until the work is done right.",
    ...
    intro: [
      ...
      "Post your job, get up to three fixed-price quotes, and book — with payment held until you confirm the work is done.",
    ],
    cover: [
      "AC installation",
    ...
    faqs: [
      { q: "How much is AC install in Calgary?", a: "Installs are quoted as a flat job price. You'll get up to three quotes to compare before booking." },
      { q: "Can you repair an existing unit?", a: "Yes — describe the issue and you'll get fixed-price quotes from local HVAC pros." },
  ...
  "windows-doors": {
    ...
    metaDesc: "Calgary window and door repair, replacement and weatherproofing from vetted pros. Post your job, get up to 3 fixed-price quotes. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your job, compare up to three fixed-price quotes, and book — with your payment held until the work is confirmed done.",
    ],
    cover: [
    ...
    faqs: [
      { q: "Can you fix a drafty door?", a: "Yes — weatherproofing and adjustments are common jobs. Post it for fixed-price quotes." },
      { q: "Do you install new windows?", a: "Absolutely. Describe the openings and you'll get up to three quotes from local pros." },
  ...
  "garage": {
    ...
    metaDesc: "Calgary garage door repair, opener installs and builds from vetted local pros. Post your job, get up to 3 fixed-price quotes. Payment held until you're satisfied.",
    ...
    faqs: [
      { q: "My garage door won't open — can you help?", a: "Yes, and you can mark it urgent so nearby pros are notified quickly. Add a photo for accurate quotes." },
      { q: "Do you install openers?", a: "Absolutely — note the type you want and you'll get fixed-price quotes." },
  ...
  "cleaning": {
    ...
    metaDesc: "Calgary house cleaning — deep cleans, move-outs and regular upkeep from vetted pros. Post your job, get up to 3 fixed-price quotes. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your job, compare up to three fixed-price quotes, and book the cleaner you like. Payment is held until you confirm the job's done.",
    ],
    cover: [
      "Deep cleans",
    ...
    faqs: [
      { q: "Can I book a recurring clean?", a: "Yes — note that you want recurring service when you post and cleaners will quote accordingly." },
      { q: "Do cleaners bring supplies?", a: "Most do — confirm in the quote. Note any preferences when you post." },
      { q: "Is payment protected?", a: "Yes — funds are held until you confirm the work is complete." },
    ],
    ...
    <div style={{ fontFamily: "'DM Sans',sans-serif", background: NAVY, color: TEXT, minHeight: "100vh", padding: "6rem 1.5rem 5rem" }}>
      ...
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", gap: ".8rem", flexWrap: "wrap", margin: "1.8rem 0 2.4rem" }}>
          <button className="sl-btn" onClick={book}>Get up to 3 free quotes →</button>
          <button className="sl-btn" style={{ background: "transparent", border: "1px solid rgba(234,107,20,.5)", color: TEXT }} onClick={() => setLocation("/get-a-quote")}>Get a quote first</button>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(160px,1fr))", gap: ".8rem", marginBottom: "2.6rem" }}>
          {[
            ...
            { n: "2", t: "Compare quotes", d: "Get up to 3 fixed-price quotes from vetted local pros." },
        ...
        <div style={{ background: "linear-gradient(135deg,rgba(234,107,20,.16),rgba(234,107,20,.04))", border: "1px solid rgba(234,107,20,.25)", borderRadius: 16, padding: "1.8rem", textAlign: "center" }}>
          ...
          <p style={{ color: MUTED, fontWeight: 300, marginBottom: "1.2rem" }}>Post your job free and get up to 3 fixed-price quotes from vetted Calgary pros.</p>
          <button className="sl-btn" onClick={book}>Get my free quotes →</button>
        </div>
      </div>
    </div>
  );
