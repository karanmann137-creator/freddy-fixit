...
// Shapes sourced from the Lucide icon set (ISC licensed) and adapted inline —
// no npm dependency is added; see CLAUDE.md for why this project hand-rolls
// its icon component instead of importing lucide-react.
const ICONS: Record<IconName, React.ReactNode> = {
  ...
  "radio-on": <><path d="M16.247 7.761a6 6 0 0 1 0 8.478" /><path d="M19.075 4.933a10 10 0 0 1 0 14.134" /><path d="M4.925 19.067a10 10 0 0 1 0-14.134" /><path d="M7.753 16.239a6 6 0 0 1 0-8.478" /><circle cx="12" cy="12" r="2" /></>,
  "radio-off": <circle cx="12" cy="12" r="10" />,
  wave: <><path d="M2 12q2.5 2 5 0t5 0 5 0 5 0" /><path d="M2 19q2.5 2 5 0t5 0 5 0 5 0" /><path d="M2 5q2.5 2 5 0t5 0 5 0 5 0" /></>,
  ...
  // Added 2026-08-28 for the collapsible request card on the client dashboard.
  // Lucide path data, same as every other glyph here — do NOT substitute a
  // text caret or a rotated arrow; a disclosure control that isn't a chevron
  // reads as a different affordance.
