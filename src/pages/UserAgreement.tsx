    ...
    <div style={{ fontFamily:"'DM Sans',sans-serif", background:"var(--ff-bg)", color:"var(--ff-text)", minHeight:"100vh", padding:"6rem clamp(1rem, 4vw, 1.5rem) 4rem" }}>
      ...
      <div style={{ maxWidth:"800px", margin:"0 auto" }}>
        ...
        <section style={{ marginBottom:"2.5rem" }}>
          ...
          <p><strong>6.3 Payment.</strong> Clients agree to pay the full agreed Job price through the Platform. For standard Jobs, the price is collected in <strong>two payments</strong>: a <strong>deposit</strong> (currently <strong>40% of the Job price</strong>, plus the Client service fee described in Section 6.7) charged when you book the Contractor, and the <strong>remaining balance</strong> charged when the work is finished. Both payments are <strong>held securely by the Company through its payment processor</strong>, and <strong>nothing is released to the Contractor &mdash; including the deposit &mdash;</strong> until the Job is completed and you confirm it (or it is auto-confirmed under Section 6.4). Your payout to the Contractor cannot be released until the full price has been collected. The deposit percentage in effect is the one disclosed to you at the time you book. For staged Jobs, each stage is charged when you fund it (see Section 6.8). By using the Platform, you authorize the Company to collect payment on the Contractor&rsquo;s behalf.</p>
