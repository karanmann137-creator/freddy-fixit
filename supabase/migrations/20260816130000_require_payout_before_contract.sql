...
-- Written 2026-08-16. APPLIED LIVE 2026-08-16 via Supabase MCP.
--
-- Applied when the platform had 1 job, 0 contracts, 0 jobs ever held and 0
-- unpaid jobs whose contractor lacks payouts — so it blocked nothing that
-- already existed. All six branches were exercised in a self-rolling-back
-- transaction and all six returned the right text; the four original reasons
-- are byte-identical. platform_health_check() was 7/7 before and after.
--
-- Payout guards touched: NONE. This gate sits upstream of every one of them —
-- it stops the agreement being signed, and an unsigned agreement already makes
-- create-payment-intent, create-balance-payment, create-milestone-payment and
-- create-recurring-prepayment return 428. confirm_job_completion,
-- auto_confirm_stale_jobs, release-payment and reconcile-payouts are unchanged
-- and their four-way invariant is unaffected.
--
