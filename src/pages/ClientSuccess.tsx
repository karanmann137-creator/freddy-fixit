    ...
    <div className="ff-wrap">
      ...
      <div className="ff-container">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }}>
          ...
          <a href="https://wa.me/14031234567?text=Hi%20Freddy%20Fix%20It%2C%20I%20just%20submitted%20a%20job%20request!" target="_blank" rel="noopener noreferrer" className="ff-whatsapp">
