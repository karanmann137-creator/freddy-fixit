  ...
  return (
    <div className="ff-root">
      <style>{`
        ...
        .ff-card-cta   { margin-top: 0.5rem; font-size: 0.78rem; font-weight: 500; letter-spacing: 0.1em; text-transform: uppercase; color: #ea6b14; display: flex; align-items: center; gap: 0.3rem; }
        ...
        .ff-whatsapp:hover { background: rgba(37,211,102,0.2); box-shadow: 0 0 16px rgba(37,211,102,0.2); }
      ...
      <motion.div className="ff-inner" initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: "easeOut" }}>
        ...
        <motion.a href="https://wa.me/14031234567" target="_blank" rel="noopener noreferrer" className="ff-whatsapp"
