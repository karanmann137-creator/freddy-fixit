...
export const SERVICES: Record<string, Svc> = {
  "handyman": {
    ...
    metaDesc: "Need a handyman in Calgary? Post your job free and get up to 5 written estimates from vetted, insured local pros. Payment held safe until the work is done right.",
    ...
    intro: [
      ...
      "Post your job in a couple of minutes, get up to five written estimates, and book the pro you like best. You pay a 40% deposit to book and the balance when the job is finished — both held securely, and only released once you confirm the work is done right.",
    ],
    cover: [
    ...
    faqs: [
      { q: "How much does a handyman cost in Calgary?", a: "Most Calgary handyman work is estimated by the job rather than the hour, so you see the price before you book and it cannot change afterwards without your approval. Small jobs typically start in the low hundreds. You get up to five estimates to compare, with no obligation. Some pros will ask to see the space first before quoting a firm number." },
  ...
  "plumbing": {
    ...
    metaDesc: "Find a licensed plumber in Calgary fast. Post your leak, install or repair and get up to 5 written estimates from vetted local plumbers. Payment protected until you're satisfied.",
    ...
    intro: [
      ...
      "Describe the problem, get up to five written estimates, and choose your plumber. Funds are held safely and released only when you confirm the job's done.",
    ],
    cover: [
  ...
  "electrical": {
    ...
    metaDesc: "Hire a certified electrician in Calgary. Post your job and get up to 5 written estimates from vetted, insured local electricians. Safe, code-compliant work, payment protected.",
    ...
    intro: [
      ...
      "Post the job, compare up to five written estimates, and book with confidence. Your money is held until you confirm the work is finished properly.",
    ],
    cover: [
    ...
    faqs: [
      ...
      { q: "Can I get an estimate for a panel upgrade?", a: "Absolutely. Describe the job (and add photos of your panel if you can) and you'll get up to five written estimates to compare." },
  ...
  "hvac": {
    ...
    metaDesc: "Furnace acting up? Get vetted Calgary HVAC pros for heating, cooling and ventilation. Post your job, get up to 5 written estimates. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your job, get up to five written estimates, and book a pro. Payment is protected and only released when the work is confirmed done.",
    ],
    cover: [
  ...
  "carpentry": {
    ...
    metaDesc: "Find a skilled carpenter in Calgary for custom builds, repairs and finishing. Post your job, get up to 5 written estimates from vetted local pros. Payment protected.",
    ...
    intro: [
      ...
      "Post your project, compare up to five written estimates, and book the carpenter whose work you like best — with your payment held until you're happy.",
    ],
    cover: [
    ...
    faqs: [
      { q: "Can I get an estimate for custom work?", a: "Yes. Describe what you want (photos and rough dimensions help) and you'll get up to five written estimates from local carpenters." },
  ...
  "painting": {
    ...
    metaDesc: "Hire vetted painters in Calgary for interior and exterior jobs. Post your project, get up to 5 written estimates from insured local pros. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your job, get up to five written estimates, and book your painter. Payment is held until the work is confirmed done right.",
    ],
    cover: [
    ...
    faqs: [
      { q: "How much does painting cost in Calgary?", a: "Painting is usually estimated per room or per job. You'll get up to five written estimates so you can compare before booking." },
  ...
  "drywall-flooring": {
    ...
    metaDesc: "Calgary drywall and flooring pros for patches, repairs and full installs. Post your job, get up to 5 written estimates from vetted locals. Payment held until you're happy.",
    ...
    intro: [
      ...
      "Post the job, compare up to five written estimates, and book — with your payment protected until you confirm the work is done.",
    ],
    cover: [
    ...
    faqs: [
      { q: "Can you patch a small hole in drywall?", a: "Yes — small repairs are some of the most common jobs booked. Post it and you'll get written estimates fast." },
  ...
  "landscaping": {
    ...
    metaDesc: "Calgary landscaping, lawn care and yard cleanup from vetted local pros. Post your job, get up to 5 written estimates. Payment held until the work is done right.",
    ...
    intro: [
      ...
      "Post your job, get up to five written estimates, and book the crew you like. Payment is held until you confirm the work is finished.",
    ],
    cover: [
    ...
    faqs: [
      ...
      { q: "How do estimates work?", a: "You get up to five written estimates to compare — no hourly surprises." },
  ...
  "snow-removal": {
    ...
    metaDesc: "Reliable Calgary snow removal for driveways, walks and lots. Post your job, get up to 5 written estimates from vetted local crews. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your job, compare up to five written estimates, and book. Payment is protected until the work is confirmed done.",
    ],
    cover: [
  ...
  "gutters": {
    ...
    metaDesc: "Calgary gutter cleaning, repair and installs from vetted local pros. Post your job, get up to 5 written estimates. Payment held until the work is done right.",
    ...
    intro: [
      ...
      "Post the job, compare up to five written estimates, and book — with payment held until you confirm it's done.",
    ],
    cover: [
    ...
    faqs: [
      { q: "How often should Calgary gutters be cleaned?", a: "Twice a year is typical — spring and fall. Post the job and you'll get written estimates from local pros." },
  ...
  "siding-roofing": {
    ...
    metaDesc: "Calgary roofing and siding repair, replacement and leak protection from vetted pros. Post your job, get up to 5 written estimates. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your job, get up to five written estimates, and book with confidence — payment held until the work is confirmed done.",
    ],
    cover: [
      "Roof leak repair",
      "Shingle replacement",
    ...
    faqs: [
      ...
      { q: "Do you do full roof replacements?", a: "Absolutely — describe the roof and you'll get up to five written estimates from local roofers." },
  ...
  "concrete-masonry": {
    ...
    metaDesc: "Calgary concrete and masonry pros for driveways, patios, walks and repairs. Post your job, get up to 5 written estimates from vetted locals. Payment protected.",
    ...
    intro: [
      ...
      "Post your project, compare up to five written estimates, and book — with your payment held until you confirm the job's done.",
    ],
    cover: [
    ...
    faqs: [
      { q: "Can you repair cracked concrete?", a: "Yes — repairs are common. Add a photo when you post for accurate written estimates." },
  ...
  "appliance-repair": {
    ...
    metaDesc: "Calgary appliance repair and installation for all major brands. Post your job, get up to 5 written estimates from vetted local pros. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post the make, model and problem, get up to five written estimates, and book. Payment is held until you confirm the fix.",
    ],
    cover: [
    ...
    faqs: [
      ...
      { q: "Do you install new appliances?", a: "Yes — installs and hookups are common jobs. Note what you need and you'll get written estimates." },
  ...
  "vehicle-maintenance": {
    ...
    metaDesc: "Calgary vehicle maintenance — oil changes, tires, brakes and more from vetted local pros. Post your job, get up to 5 written estimates. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your vehicle and the service you need, get up to five written estimates, and book. Payment is held until the work is confirmed done.",
    ],
    cover: [
    ...
    faqs: [
      ...
      { q: "How do estimates work?", a: "You'll get up to five written estimates to compare before you book — no hourly surprises." },
      { q: "Is payment protected?", a: "Yes — funds are held securely until you confirm the work is complete." },
    ],
  ...
  "air-conditioning": {
    ...
    metaDesc: "Calgary AC installs, tune-ups and repairs from vetted local pros. Post your job, get up to 5 written estimates. Payment held until the work is done right.",
    ...
    intro: [
      ...
      "Post your job, get up to five written estimates, and book — with payment held until you confirm the work is done.",
    ],
    cover: [
      "AC installation",
    ...
    faqs: [
      ...
      { q: "Can you repair an existing unit?", a: "Yes — describe the issue and you'll get written estimates from local HVAC pros." },
  ...
  "windows-doors": {
    ...
    metaDesc: "Calgary window and door repair, replacement and weatherproofing from vetted pros. Post your job, get up to 5 written estimates. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your job, compare up to five written estimates, and book — with your payment held until the work is confirmed done.",
    ],
    cover: [
    ...
    faqs: [
      { q: "Can you fix a drafty door?", a: "Yes — weatherproofing and adjustments are common jobs. Post it for written estimates." },
  ...
  "garage": {
    ...
    metaDesc: "Calgary garage door repair, opener installs and builds from vetted local pros. Post your job, get up to 5 written estimates. Payment held until you're satisfied.",
    ...
    faqs: [
      ...
      { q: "Do you install openers?", a: "Absolutely — note the type you want and you'll get written estimates." },
  ...
  "cleaning": {
    ...
    metaDesc: "Calgary house cleaning — deep cleans, move-outs and regular upkeep from vetted pros. Post your job, get up to 5 written estimates. Payment held until you're satisfied.",
    ...
    intro: [
      ...
      "Post your job, compare up to five written estimates, and book the cleaner you like. Payment is held until you confirm the job's done.",
    ],
    cover: [
      "Deep cleans",
    ...
    <div style={{ fontFamily: "'DM Sans',sans-serif", background: NAVY, color: TEXT, minHeight: "100vh", padding: "6rem clamp(1rem, 4vw, 1.5rem) 5rem" }}>
      ...
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        ...
        <div style={{ background: "linear-gradient(135deg,rgba(234,107,20,.16),rgba(234,107,20,.04))", border: "1px solid rgba(234,107,20,.25)", borderRadius: 16, padding: "1.8rem", textAlign: "center" }}>
          ...
          <p style={{ color: MUTED, fontWeight: 300, marginBottom: "1.2rem" }}>Post your job free and get up to 5 written estimates from vetted Calgary pros.</p>
