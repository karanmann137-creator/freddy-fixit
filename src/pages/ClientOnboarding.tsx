...
export default function ClientOnboarding() {
  ...
  const s = {
    wrap: { minHeight:"100vh", background:"#1a2236", backgroundImage:"linear-gradient(rgba(26,34,54,0.90), rgba(26,34,54,0.95)), radial-gradient(ellipse 50% 32% at 18% -4%, rgba(234,107,20,0.30) 0%, transparent 68%), radial-gradient(ellipse 55% 36% at 84% -8%, rgba(234,107,20,0.18) 0%, transparent 70%), repeating-linear-gradient(45deg, transparent 0 26px, rgba(255,255,255,0.022) 26px, rgba(255,255,255,0.022) 27px), repeating-linear-gradient(-45deg, transparent 0 26px, rgba(255,255,255,0.018) 26px, rgba(255,255,255,0.018) 27px), url(\"https://images.unsplash.com/photo-1750128973550-750f796f431b?auto=format&fit=crop&w=1600&q=65\")", backgroundSize:"auto, auto, auto, auto, auto, cover", backgroundPosition:"center, center, center, center, center, center", backgroundAttachment:"fixed", padding:"3rem 1rem 4rem", fontFamily:"'DM Sans',sans-serif", color:"#f0f4ff" },
          ...
          {step === 2 && (
            <div>
              ...
              <div style={{ marginBottom:"1.2rem" }}>
                ...
                <input style={{ ...inp, borderColor: errors.location ? "rgba(239,68,68,.6)" : "rgba(255,255,255,.1)" }} placeholder="e.g. 123 Main St NW" value={form.location} onChange={e => set("location",e.target.value)} />
